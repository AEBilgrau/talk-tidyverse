...
```{r, echo = -1}
set.seed(1)
tbl <- tibble(a = rnorm(10), b = rnorm(10), c = rnorm(10), d = runif(10))
print(tbl)
```
...
.pull-left[
<!-- ![](img/wilkinson_grammar_of_graphics.png) -->
<img src="figs/wilkinson_grammar_of_graphics.png" width=300 height=400>
]

.pull-right[
<!-- ![](https://research.tableau.com/sites/default/files/900x890_Leland.jpg) -->
<img src="img/leland.jpg" width=300 height=297>
]
...
```{r, message=FALSE}
it <- map_data("italy")
ggplot(data = it, mapping = aes(long, lat, group = group)) +
...
---
```{r}
ggplot(data = it, mapping = aes(long, lat, group = group, fill = region))+
